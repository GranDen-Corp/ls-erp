  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        ...
        <div>
          <Link href={`/products/all/${encodeURIComponent(customerId)}/${encodeURIComponent(productId)}/inquiry`}>
            <Button variant="outline" className="mr-2">
              <FileText className="mr-2 h-4 w-4" />
              生成詢價單
            </Button>
          </Link>
          <Link href={`/products/all/${encodeURIComponent(customerId)}/${encodeURIComponent(productId)}/edit`}>
