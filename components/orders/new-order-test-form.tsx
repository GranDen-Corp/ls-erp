...
import { Plus, Trash, Layers, AlertCircle, Package, Settings } from "lucide-react"
...
export const NewOrderTestForm = forwardRef<any, NewOrderTestFormProps>(({ timestamp, onSubmit }, ref) => {
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          <Label htmlFor="orderId">訂單編號 (時間戳)</Label>
          <Input id="orderId" value={timestamp} readOnly className="bg-gray-50" />
        </div>
        <div className="space-y-2">
      ...
      <div className="space-y-4">
        <Tabs value={productSelectionTab} onValueChange={setProductSelectionTab} className="w-full">
          ...
          <TabsContent value="regular" className="space-y-4 pt-4">
            ...
            <Button onClick={handleAddSelectedProducts} disabled={selectedProducts.size === 0} className="w-full">
